...
""" TODO: 
Remove weighting scheming above, this is not for preprocessing even if motivation of weights is good
This also cannot be done until preprocessing is done. 
"""
...
"""
TODO: Above code is far too long for one hot encoding, I believe there's a shorter way to do it 
and hard codes categorical column names, bad practice. These aren't even categorical. They are just numerical cols 
that need to be binned. 
"""
